...
## Context
You are an AI assistant using Windsurf IDE. You have access to a large library of skills (25+). Loading all of them simultaneously causes context bloat and reduces model performance.
...
3. Reference only those `.md` files in the `.windsurfrules` or prompt context.
